...
var NgPdf = exports.NgPdf = ["$window", "$document", "$log","$ionicScrollDelegate", function NgPdf($window, $document, $log,$ionicScrollDelegate) {
  'ngInject';
    ...
    link: function link(scope, element, attrs) {
      ...
      scope.goPrevious = function () {
        ...
        scope.pageNum = scope.pageToDisplay;
				$ionicScrollDelegate.$getByHandle('pdfCanvas').scrollTop();
